...
public class LeftOuterJoinTest {
    ...
    String setup =
            "  CREATE TABLE foo (" +
                    ...
                    "  STORED AS TEXTFILE" +
                    "  LOCATION '${hiveconf:hadoop.tmp.dir.uri}/foo' ; "
                    +
                    "  CREATE TABLE bar (" +
                    " id string," +
                    " value string" +
                    ...
                    "  ROW FORMAT DELIMITED FIELDS TERMINATED BY '\t'" +
                    "  STORED AS TEXTFILE" +
                    "  LOCATION '${hiveconf:hadoop.tmp.dir.uri}/bar' ;" +
                    "";
    ...
    public void leftOuterJoin() {
        hiveShell.addResource("${hiveconf:hadoop.tmp.dir}/foo/data.csv",
                "id1\tfoo_value1\nid3\tfoo_value3");
        hiveShell.addResource("${hiveconf:hadoop.tmp.dir}/bar/data.csv",
                "id1\tbar_value1\n" +
                        "id2\tbar_value2");
        hiveShell.start();
